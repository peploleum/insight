...
public class BiographicsResource {
    ...
    @Timed
    public ResponseEntity<List<BiographicsDTO>> getAllBiographics(BiographicsCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Biographics by criteria: {}", criteria);
        Page<BiographicsDTO> page = biographicsQueryService.findByCriteria(criteria, pageable);
    ...
    @Timed
    public ResponseEntity<BiographicsDTO> getBiographics(@PathVariable Long id) {
