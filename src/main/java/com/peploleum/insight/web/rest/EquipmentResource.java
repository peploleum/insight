...
public class EquipmentResource {
    ...
    public EquipmentResource(EquipmentService equipmentService, EquipmentQueryService equipmentQueryService) {
    ...
    @Timed
    public ResponseEntity<List<EquipmentDTO>> getAllEquipment(EquipmentCriteria criteria, Pageable pageable) {
