...
export class BiographicsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.registerChangeInBiographics();
    }
    ...
    registerChangeInBiographics() {
        this.eventSubscriber = this.eventManager.subscribe('biographicsListModification', response => this.loadAll());
    }
    ...
    private paginateBiographics(data: IBiographics[], headers: HttpHeaders) {
