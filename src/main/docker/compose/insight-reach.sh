...
docker-compose -f insight-reach.yml down
...
docker-compose -f insight-reach.yml -p insight up -d --build
...
docker-compose -f insight-reach.yml -p insight up -d
...
docker-compose -f insight-reach.yml -p insight down
;;
esac
