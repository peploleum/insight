...
import { CourseOfActionComponent } from 'app/entities/course-of-action/course-of-action.component';
...
describe('Component Tests', () => {
    describe('CourseOfAction Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CourseOfActionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.courseOfActions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
