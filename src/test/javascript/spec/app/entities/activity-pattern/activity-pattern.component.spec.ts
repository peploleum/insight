...
import { ActivityPatternComponent } from 'app/entities/activity-pattern/activity-pattern.component';
...
describe('Component Tests', () => {
    describe('ActivityPattern Management Component', () => {
        let comp: ActivityPatternComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ActivityPatternComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.activityPatterns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
