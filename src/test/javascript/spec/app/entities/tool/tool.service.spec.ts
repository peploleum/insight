    ...
    describe('Tool Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tools';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Tool', () => {
                service.create(new Tool(null)).subscribe(received => {
            ...
            it('should update a Tool', () => {
                service.update(new Tool(123)).subscribe(received => {
