...
import { IntrusionSetComponent } from 'app/entities/intrusion-set/intrusion-set.component';
...
describe('Component Tests', () => {
    describe('IntrusionSet Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(IntrusionSetComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.intrusionSets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
