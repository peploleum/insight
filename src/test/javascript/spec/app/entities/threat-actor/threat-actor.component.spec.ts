...
import { ThreatActorComponent } from 'app/entities/threat-actor/threat-actor.component';
...
describe('Component Tests', () => {
    describe('ThreatActor Management Component', () => {
        let comp: ThreatActorComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ThreatActorComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.threatActors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
