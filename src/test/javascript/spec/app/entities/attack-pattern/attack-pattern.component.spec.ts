...
import { AttackPatternComponent } from 'app/entities/attack-pattern/attack-pattern.component';
...
describe('Component Tests', () => {
    describe('AttackPattern Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AttackPatternComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.attackPatterns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
