...
export class CourseOfActionComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    title = element.all(by.css('jhi-course-of-action div h2#page-heading span')).first();
...
export class CourseOfActionUpdatePage {
    pageTitle = element(by.id('jhi-course-of-action-heading'));
