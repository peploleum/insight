 ...
 */
class OrganisationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Organisation entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "organisationName":"SAMPLE_TEXT", "organisationSize":null, "organisationCoordinates":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
